...
?>
			...
			<div class="panel panel-default">
				<div class="panel-heading">
					<h4><i class="glyphicon glyphicon-list"></i>Banner</h4>
						...
						<table id="example1" class="table table-bordered table-striped">
							...
							<tbody>
								...
								<tr>
									...
									<td><img src="../gambar/pengiriman/<?php echo $row['gambar']; ?>" style="width:150px;"/></td>
				...
				<div class="panel-body">	 
					...
					?>
						<div class="form-group">
							<label class="control-label col-sm-4">Banner</label>
							<div class="col-sm-5">
								<input type="text"  class="form-control" value="<?php echo isset ($metode) ? $metode : ""; ?>" name="metode" placeholder="Banner" maxlength="100" required autofocus />
							</div>
						</div>
						<div class="form-group">
			...
			<div class="panel panel-default">
				<div class="panel-heading">
					<h4><i class="glyphicon glyphicon-edit"></i>   Ubah Banner</h4>
