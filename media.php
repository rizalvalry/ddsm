...
?>
        ...
        <!-- Favicon -->
		<link rel="shortcut icon" type="image/x-icon" href="favicon_io_ddsm/favicon.ico">
        <!-- individu source -->
        <link rel="apple-touch-icon" sizes="180x180" href="favicon_io_ddsm/apple-touch-icon.png">
        <link rel="icon" type="image/png" sizes="32x32" href="favicon_io_ddsm/favicon-32x32.png">
        <link rel="icon" type="image/png" sizes="16x16" href="favicon_io_ddsm/favicon-16x16.png">
        <link rel="manifest" href="favicon_io_ddsm/site.webmanifest">
        <link rel="mask-icon" href="favicon_io_ddsm/safari-pinned-tab.svg" color="#5bbad5">
